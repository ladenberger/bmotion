	...
	if(!window.methodDraw) window.methodDraw = function($) {
		...
		curConfig = {
		  ...
		  initStroke: {width: 1.5, color: '000', opacity: 1},
			initOpacity: 1,
			imgPath: '/bms/libs/bmseditor/images/',
			extPath: '/bms/libs/bmseditor/extensions/',
			jGraduatePath: '/bms/libs/bmseditor/lib/jgraduate/images/',
			extensions: [],
			initTool: 'select',
			wireframe: false,
        ...
        .on('mouseover', function() {
			...
			*/
			...
			var clickSavedata = function() {
				var svg = {
					name: methodDraw.workingSvgFile,
...
// 				var opacity = (picker == 'stroke' ? $('#stroke_opacity') : $('#fill_opacity'));
        ...
        if (type === 'canvas') docElem.setAttribute('width',60.5);
			...
			setTimeout(function() {
				svgCanvas.embedImage('/bms/libs/bmseditor/images/placeholder.svg', function(datauri) {
					if(!datauri) {
						// Disable option
